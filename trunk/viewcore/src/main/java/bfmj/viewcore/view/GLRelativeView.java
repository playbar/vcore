...
import bfmj.viewcore.render.GLConstant.GLAlign;
...
public class GLRelativeView extends GLGroupView {
	...
	public void addView(GLRectView view, GLAlign align) {
		if (align == GLAlign.TOP) {
			addViewTop(view);
		} else if (align == GLAlign.BOTTOM) {
			addViewBottom(view);
		} else if (align == GLAlign.LEFT) {
			addViewLeft(view);
		} else if (align == GLAlign.RIGHT) {
			addViewRight(view);
		} else if (align == GLAlign.LEFT_TOP) {
			addViewLeftTop(view);
		} else if (align == GLAlign.RIGHT_TOP) {
			addViewRightTop(view);
		} else if (align == GLAlign.LEFT_BOTTOM) {
			addViewLeftBottom(view);
		} else if (align == GLAlign.RIGHT_BOTTOM) {
			addViewRightBottom(view);
		} else if (align == GLAlign.CENTER) {
			addViewCenter(view);
	...
	public void addViewLeftTop(GLRectView view) {
		view.setAlign(GLAlign.LEFT_TOP);
		view.setX(getX() + getPaddingLeft() + view.getMarginLeft());
		view.setY(getY() + getPaddingTop() + view.getMarginTop());
	...
	public void addViewRightTop(GLRectView view) {
		view.setAlign(GLAlign.RIGHT_TOP);
		view.setX(getX() + getWidth() - getPaddingRight() - view.getWidth() - view.getMarginRight());
		view.setY(getY() + getPaddingTop() + view.getMarginTop());
	...
	public void addViewLeftBottom(GLRectView view) {
		view.setAlign(GLAlign.LEFT_BOTTOM);
		view.setX(getX() + getPaddingLeft() + view.getMarginLeft());
		view.setY(getY() + getHeight() - getPaddingBottom() - view.getHeight() - view.getMarginBottom());
	...
	public void addViewRightBottom(GLRectView view) {
		view.setAlign(GLAlign.RIGHT_BOTTOM);
		view.setX(getX() + getWidth() - getPaddingRight() - view.getWidth() - view.getMarginRight());
		view.setY(getY() + getHeight() - getPaddingBottom() - view.getHeight() - view.getMarginBottom());

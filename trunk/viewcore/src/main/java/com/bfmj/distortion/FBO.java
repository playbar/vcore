...
public class FBO {
	public int[] mTextureIds = {0, 0};
	private int []framebufferId = {0, 0};
	private int depthbufferId;
	private int colorbufferId;
	private int mTextureWidth = 0;
	private int mTextureHeight = 0;
	private static FBO mInstance;

	public static FBO getInstance() {
		if (mInstance == null) {
			mInstance = new FBO();
		}
	...
	public void setScreen(int width, int height) {
		this.framebufferId[0] = generateFrameBufferObject();
		this.framebufferId[1] = generateFrameBufferObject();
		...
		GLES30.glBindFramebuffer(GLES30.GL_FRAMEBUFFER, this.framebufferId[0]);

		GLES30.glBindRenderbuffer( GLES30.GL_RENDERBUFFER, this.depthbufferId);
		GLES30.glRenderbufferStorage( GLES30.GL_RENDERBUFFER, GLES30.GL_DEPTH_COMPONENT24, 2048, 2048);
		GLES30.glBindRenderbuffer( GLES30.GL_RENDERBUFFER, this.colorbufferId);
		GLES30.glRenderbufferStorage( GLES30.GL_RENDERBUFFER, GLES30.GL_RGBA, 2048, 2048);

		GLES30.glFramebufferRenderbuffer(GLES30.GL_FRAMEBUFFER, GLES30.GL_DEPTH_ATTACHMENT, GLES30.GL_RENDERBUFFER, this.depthbufferId);
		GLES30.glFramebufferRenderbuffer(GLES30.GL_RENDERBUFFER, GLES30.GL_COLOR_ATTACHMENT0, GLES30.GL_RENDERBUFFER, this.colorbufferId);

		GLES30.glBindFramebuffer(GLES30.GL_FRAMEBUFFER, this.framebufferId[1]);
		GLES30.glFramebufferRenderbuffer(GLES30.GL_FRAMEBUFFER, GLES30.GL_DEPTH_ATTACHMENT, GLES30.GL_RENDERBUFFER, this.depthbufferId);
		GLES30.glFramebufferRenderbuffer(GLES30.GL_RENDERBUFFER, GLES30.GL_COLOR_ATTACHMENT0, GLES30.GL_RENDERBUFFER, this.colorbufferId);
	...
	private void initData() {
		...
		this.framebufferId[1] = -1;
	}
	
	public void beforeDraw(int eye){
		GLES30.glBindFramebuffer(GLES30.GL_FRAMEBUFFER, this.framebufferId[eye]);

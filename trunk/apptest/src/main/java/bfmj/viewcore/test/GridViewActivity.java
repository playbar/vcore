...
import bfmj.viewcore.view.GLAdapterView;
import bfmj.viewcore.view.GLCursorView;
import bfmj.viewcore.view.GLGridView;
import bfmj.viewcore.view.GLGridViewPage;
...
import bfmj.viewcore.view.GLView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		GLAdapterView.OnItemClickListener clickListener = new GLAdapterView.OnItemClickListener(){
			public void onItemClick(GLAdapterView<?> glparent, GLView glview, int position, long id){
				Log.e("bfmj/viewcore/test", "onItemClick");

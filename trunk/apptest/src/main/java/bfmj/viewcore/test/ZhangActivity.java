...
import bfmj.viewcore.animation.GLAnimation.OnGLAnimationListener;
...
import bfmj.viewcore.view.GLLinearView;
...
//		senceView.rotate(180, 0, 1, 0);
		...
		Log.d("bfmj/viewcore/test", "transSTART:"+gview.getDepth());
		...
		animation.setOnGLAnimationListener(new OnGLAnimationListener() {
			...
			public void onAnimationEnd(GLAnimation animation) {
				...
				Log.d("bfmj/viewcore/test", "transEND:"+gview.getDepth());
			}
		});

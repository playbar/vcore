 ...
 * Original file: G:\\projects\\MJ\\MojingSDK\\Core\\VrService\\src\\com\\baofeng\\com.baofeng.mojing\\com.baofeng.mojing.service\\MojingSDKAIDLService.aidl
 */
...
@Override public void clientResume(String packageName, com.baofeng.mojing.service.IServiceResponse callback) throws android.os.RemoteException
{
...
@Override public void clientPause(String packageName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void clientResume(String packageName, com.baofeng.mojing.service.IServiceResponse callback) throws android.os.RemoteException;
public void clientPause(String packageName) throws android.os.RemoteException;
}
